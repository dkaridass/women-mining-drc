      ...
      <div className="min-h-screen">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Moments de la Conférence Nationale 2024
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Découvrez les moments forts de notre conférence historique qui a rassemblé les femmes leaders du secteur minier congolais.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  <img
                    src="/attached_assets/galerie/wim-2024/jourI1 2.jpg"
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Cérémonie d'ouverture</h3>
                    <p className="text-sm text-gray-200">Conférence Nationale WIM DRC 2024</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  <img
                    src="/attached_assets/galerie/wim-2024/jourI9 2.jpg"
                    alt="Sessions de travail et échanges professionnels"
                    className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Sessions de travail</h3>
                    <p className="text-sm text-gray-200">Échanges et réseautage professionnel</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  <img
                    src="/attached_assets/galerie/wim-2024/jourDeux4.jpg"
                    alt="Ateliers de formation et renforcement des capacités"
                    className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-300"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Formation technique</h3>
                    <p className="text-sm text-gray-200">Renforcement des capacités</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Travaux de groupe</h3>
                    <p className="text-sm text-gray-200">Réflexions collectives</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  <img
                    src="/attached_assets/galerie/wim-2024/jourDeux7.jpg"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Présentations</h3>
                    <p className="text-sm text-gray-200">Partages d'expériences</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
                  <img
                    src="/attached_assets/galerie/wim-2024/jourDeux16.jpg"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-lg font-semibold mb-1">Photo de groupe</h3>
                    <p className="text-sm text-gray-200">Conférence Nationale 2024</p>
                  </div>
                </div>
              </div>
            </div>
